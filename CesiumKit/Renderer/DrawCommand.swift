...
class DrawCommand: Command {
    ...
    */
    func execute(in context: Context, renderPass: RenderPass, frustumUniformBuffer: Buffer? = nil) {
        context.draw(command: self, renderPass: renderPass, frustumUniformBuffer: frustumUniformBuffer)
    }
