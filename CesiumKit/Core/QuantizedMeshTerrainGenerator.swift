...
class QuantizedMeshTerrainGenerator {
    ...
    class func addSkirt( vertexBuffer: inout [Float32], indexBuffer: inout [Int], edgeVertices: [Int], encoding: TerrainEncoding, heights: [Double], uvs: [Cartesian2], octEncodedNormals: [UInt8]?, ellipsoid: Ellipsoid, rectangle: Rectangle, skirtLength: Double, isWestOrNorthEdge: Bool, exaggeration: Double) {
    ...
    class func findMinMaxSkirts(edgeIndices: [Int], edgeHeight: Double, heights: [Double], uvs: [Cartesian2], rectangle: Rectangle, ellipsoid: Ellipsoid, toENU: Matrix4, minimum: inout Cartesian3, maximum: inout Cartesian3) -> Double {
